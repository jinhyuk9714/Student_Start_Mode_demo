...
- Select click
  ...
  - Used in: Survey university select, Survey visa select, Survey country select, Survey ARC timing select, Survey need select 1, Survey need select 2, Survey submit, Scenario 2 open chat room, Scenario 3 open scholarship item, Scenario 4 open chat room
...
- Typing on a laptop keyboard
  ...
  - Used in: Scenario 2 auto typing, Scenario 4 auto typing
- Confirmation tone
  - Role: send cue
  ...
  - Used in: Scenario 2 send message, Scenario 4 send message
- Success tone
  - Role: approval tone

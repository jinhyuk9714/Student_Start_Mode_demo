...
- Select click
  ...
  - Used in: Survey university select, Survey visa select, Survey country select, Survey ARC timing select, Survey need select 1, Survey need select 2, Survey submit, Scenario 2 open ARC locked item, Scenario 3 open chat room, Scenario 4 open chat room
- Explainer video pops whoosh light pop
  ...
  - Used in: Survey scroll to submit
- High tech bleep confirmation
  ...
  - Used in: Scenario 1 checklist complete banner
- Page forward single chime
  ...
  - Used in: Scenario 1 checklist tab, Scenario 1 smart calendar tab, Scenario 3 checklist tab
- Page back chime
  ...
  - Used in: Scenario 2 checklist tab, Scenario 2 smart calendar tab, Scenario 3 chat list tab
- Typing on a laptop keyboard
  - Role: keyboard typing
  - Source page: https://mixkit.co/free-sound-effects/type/
  - Asset URL: https://assets.mixkit.co/active_storage/sfx/2531/2531-preview.mp3
  - Local file: ../audio_work/free_mixkit_65s/sfx-typing-on-laptop-keyboard-2531.mp3
  - Used in: Scenario 3 auto typing, Scenario 4 auto typing
- Confirmation tone
  - Role: send cue
  ...
  - Used in: Scenario 3 send message, Scenario 4 send message
- Success tone
  - Role: approval tone
  - Source page: https://mixkit.co/free-sound-effects/success/
  - Asset URL: https://assets.mixkit.co/active_storage/sfx/2865/2865-preview.mp3
  - Local file: ../audio_work/free_mixkit_65s/sfx-success-tone-2865.mp3
  - Used in: Scenario 3 ARC unlock
- Digital quick tone
  ...
  - Used in: Scenario 3 next-step banner, Scenario 4 source reveal

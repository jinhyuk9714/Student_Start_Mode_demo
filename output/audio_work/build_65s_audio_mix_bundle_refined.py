...
OUTPUT_V1 = VIDEO_DIR / "student-start-mode-short-65s-audio-final-bundle-refined-v1.mp4"
OUTPUT_STABLE = VIDEO_DIR / "student-start-mode-short-65s-audio-final-bundle-refined.mp4"
SOURCES_MD = VIDEO_DIR / "student-start-mode-short-65s-audio-sources-bundle-refined.md"
EVENTS_MD = VIDEO_DIR / "student-start-mode-short-65s-audio-events-bundle-refined.md"
...
def write_sources_md() -> None:
    ...
    lines = [
        "# 65s Audio Sources (Bundle Refined)",
        "",
        "License basis",
...
def write_events_md() -> None:
    lines = [
        "# 65s Audio Event Map (Bundle Refined)",
        "",
        "Applied target",
        "- `student-start-mode-short-65s-audio-final-bundle-refined-v1.mp4`",
        "- `student-start-mode-short-65s-audio-final-bundle-refined.mp4`",
        "",
        "Coverage",
